...
public class TestList {
  ...
  public void testRemoveObject() {
    ...
    list.add(77);
    list.add(6);
    list.remove(5); // TODO Question: What does this method do? Gets rid of element @ index of 5
    // TODO fix the expected values in the assertions below
    assertEquals(6, list.size());
    assertEquals(1, list.indexOf(77));
    assertEquals(3, list.lastIndexOf(77));// the 2nd repetition becomes the last a the 3rd repetition was in the 5th position
    assertEquals(4, list.get(2).intValue());
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // TODO Question: What does this one do? Removes the first submission of the value 5
  ...
  public void testContainsAll() {
    ...
    //fail("Not yet implemented"); // remove this line when done
    assertTrue(list.containsAll(List.of(33, 44, 55, 66, 77))); //checks for the five diffeent nubmers
    assertEquals(false, list.contains(List.of(11, 22,33))); //checks these are not contained
  ...
  public void testSubList() {
    ...
    // passes
    assertEquals(List.of(77, 44, 55), list.subList(1,5));
  }
}
